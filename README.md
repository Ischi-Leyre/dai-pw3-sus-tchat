...
Once the containners are you can access our [traefik dashboard](https://traefik.jitsusmon.duckdns.org) as well as the [chat app](https://jitsusmon.duckdns.org/users).
